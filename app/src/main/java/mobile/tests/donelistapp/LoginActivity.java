    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Integer> {
        ...
        protected Integer doInBackground(Void... params) {
            ...
            try {
                ...
                String url = "https://allpurpose.000webhostapp.com/api/login";
        ...
        protected void onPostExecute(final Integer success) {
            ...
            if (success == 200) {
                ...
                startActivity(i);
                finish();
            } else if(success == 403 || success == 400){
                Toast.makeText(LoginActivity.this, "E-mail or password is incorrect", Toast.LENGTH_SHORT).show();
            } else{
                Toast.makeText(LoginActivity.this, "Error unexpected. Please try again", Toast.LENGTH_SHORT).show();
            }
        }
